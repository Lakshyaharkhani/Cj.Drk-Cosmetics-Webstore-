...
async function getRecommendationsAction(input: ProductRecommendationsInput): Promise<Product[]> {
    try {
...
export default function RelatedProducts({ productDescription, productCategory, currentProductId }: RelatedProductsProps) {
