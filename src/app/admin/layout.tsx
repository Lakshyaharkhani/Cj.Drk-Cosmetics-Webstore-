...
const AdminNavLink = ({ href, label, icon: Icon, badge }: { href: string; label: string; icon: React.ElementType; badge?: number; }) => {
...
function AdminAuthGuard({ children }: { children: React.ReactNode }) {
  ...
  if (isUserLoading || !user || user.role !== 'admin') {
    return (
        <div className="flex flex-col min-h-screen bg-[#f8f6f6] dark:bg-[#181311]">
